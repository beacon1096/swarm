...
| `monitoring` | openstatus | new uptime/status monitoring service; libSQL + Tinybird on Longhorn; status page at `status.beaco.works`; dashboard at `openstatus.beaco.works` | 1 per component |
