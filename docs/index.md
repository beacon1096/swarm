...
- [talos-ii/0014 — Tailscale subnet router via `siderolabs/tailscale` host extension](decisions/talos-ii/0014-tailscale-host-extension.md) (**superseded 2026-05-05** — host-extension policy routing conflicted with sing-box `tun-in`)
...
- [Tailscale subnet router (host extension) — operations](operations/tailscale-subnet-router.md) — **superseded** runbook retained for incident history; current Tailscale usage is in-cluster operator plus `ts-userspace`.
