...
Images use upstream GHCR commit tag `ef7691a`, pre-copied into zot as OCI manifests and pulled from `172.16.87.51:5000`. This avoids zot on-demand sync failures against some upstream manifest envelopes.
